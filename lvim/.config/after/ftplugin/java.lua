...
local bundles = {vim.fn.glob("~/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar", 1),}
    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
           {
            name = "JavaSE-8",
            path = "~/.asdf/installs/java/adoptopenjdk-8.0.345+1",
          },
          {
            name = "JavaSE-11",
            path = "~/.asdf/installs/java/adoptopenjdk-11.0.16+101",
          },
          {
            name = "JavaSE-17",
            path = "~/.asdf/installs/java/adoptopenjdk-17.0.4+101",
          },
        },
      },
      maven = {
